...
## Términos de Licenciamiento y Requisito Obligatorio de Atribución

Este proyecto es de código abierto bajo los términos de la **GNU General Public License v3.0 (GPL-3.0)** con cláusula adicional de atribución según la Sección 7(b) y 7(c) de la licencia.

### Condiciones de Uso:
1. **Conservación de Código Abierto (Copyleft Estricto):** Cualquier trabajo derivado, bifurcación (*fork*), microservicio, biblioteca o producto comercial que integre o derive de este código, modelos o arquitectura debe mantenerse bajo la misma licencia GPL-3.0 y publicar su código fuente de forma abierta y completa.
...
## Formato de Citación Académica / Técnica
